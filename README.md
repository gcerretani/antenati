...
Since the website tends to be pretty slow in the evening, we present a script to help the retrieve of the documents for your family tree. The script allows you to download all the images of multiple archive at the same time (launching multiple instance of the script), whithout any human action. Just launch the script, and have a coffee while the script downloads all the stuff for you.
